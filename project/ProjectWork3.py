...
def load_bayernData(selectedbayernData):
    selectedbayernData.to_sql("BayernData",connect,if_exists="replace")

def load_schleswigData(selectedschleswigData):
    selectedschleswigData.to_sql("SchleswigData",connect,if_exists="replace")
...
connect=sqlite3.connect('../data/Turbines.sqlite')
load_bayernData(selectedbayernData)
load_schleswigData(selectedschleswigData)
connect.close()
